...
var skillToTrack = [];
	skillToTrack.push({'Skill': 'Serve', 'Result': {'3': '+', '2': '/', '1': '-', '0': 'Error','Termination':'Ace'}});
	skillToTrack.push({'Skill': 'Pass', 'Result': {'3': '+', '2': '/', '1': '-', '0': 'Error','Termination':'Ace'}});
	skillToTrack.push({'Skill': 'Set', 'Result': {'3': '+', '2': '/', '1': '-', '0': 'Error','Termination':'Ace'}});
	skillToTrack.push({'Skill': 'Attack', 'Result': {'3': '+', '2': '/', '1': '-', '0': 'Error','Termination':'Ace'}});
	skillToTrack.push({'Skill': 'Block', 'Result': {'3': '+', '2': '/', '1': '-', '0': 'Error','Termination':'Ace'}});
	skillToTrack.push({'Skill': 'Defense', 'Result': {'3': '+', '2': '/', '1': '-', '0': 'Error','Termination':'Ace'}});
